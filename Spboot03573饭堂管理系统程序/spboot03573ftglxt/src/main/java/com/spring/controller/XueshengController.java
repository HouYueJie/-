...
public class XueshengController extends BaseController
{
    ...
    public String list()
    {
        ...
        List<Xuesheng> list = service.selectPageExample(example , page , 12);   // 获取当前页的行数
        // 将列表写给界面使用
    ...
    public String insert()
    {
        ...
        post.setChushengnianyue(Request.get("chushengnianyue"));

        post.setXiaoqu(Request.get("xiaoqu"));
    ...
    */
    ...
    public String update()
    {
        ...
        post.setXingming(Request.get("xingming"));
                if(!Request.get("xingbie").equals(""))
        post.setXingbie(Request.get("xingbie"));
                if(!Request.get("chushengnianyue").equals(""))
        post.setChushengnianyue(Request.get("chushengnianyue"));
                if(!Request.get("xiaoqu").equals(""))
        post.setXiaoqu(Request.get("xiaoqu"));
    ...
    */
    ...
    public String delete()
    {
        ...
        HashMap delMap = Query.make("xuesheng").find(id);
