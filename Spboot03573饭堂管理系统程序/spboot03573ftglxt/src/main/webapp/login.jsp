    ...
    <div class="row align-items-md-center h-100-vh">
        ...
        <div class="col-lg-4 offset-lg-1">
            <div class="d-flex align-items-center m-b-20">
                ...
                <h3 class="m-0">饭堂管理系统</h3>
            </div>
            <p>输入账号密码，登录系统.</p>
            <form action="authAdminLogin.do?ac=adminlogin&a=a" id="loginForm" name="loginForm" method="post"
                ...
                <div class="form-group mb-4">
                    <input type="password" name="pwd" class="form-control form-control-lg" id="password"
                           placeholder="密码">
                </div>
                <div class="form-group mb-4">
                    <div class="input-group">
                        <input type="text" name="pagerandom" class="form-control form-control-lg" id="pagerandom"
                               placeholder="验证码">
                        <span class="input-group-append">
                            <img src="captcha.do" style="min-width: 60px;min-height: 30px;"
                ...
                <a href="xuesheng_add.do" class="btn btn-primary btn-lg btn-block btn-uppercase mb-4">学生注册</a>
