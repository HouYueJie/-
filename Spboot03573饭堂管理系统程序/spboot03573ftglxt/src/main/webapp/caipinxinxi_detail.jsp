...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="admin-detail clearfix">
                    ...
                    <div class="detail-content">
                        <img src="${map.caipinzhutu}" style="width: 350px"/></div>
                </div>
            ...
            var images = "${map.xijiexiangtu}".split(',');
